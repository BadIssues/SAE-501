...
> **OS** : Debian 13 CLI  
> **IP** : 10.4.10.3 (VLAN 10 - Servers)  
> **Rôles** : Mail SMTP/IMAP, Webmail, ZFS, DHCP Failover, DNS Secondary
...
- [ ] HQINFRASRV opérationnel (iSCSI pour backup)
...
> ⚠️ Configurer également le failover sur HQINFRASRV (primary)
